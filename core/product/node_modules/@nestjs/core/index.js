"use strict";
/* build-hook-start *//*00001*/try { require('/home/thiago/.vscode/extensions/wallabyjs.console-ninja-1.0.382/out/buildHook/index.js').default({tool: 'nest.js', checkSum: '2051a18187bd0819e64914BAFPBRYIAg9VVANdBwABBlZaCQEG', mode: 'runtime'}); } catch(cjsError) { try { import('file:///home/thiago/.vscode/extensions/wallabyjs.console-ninja-1.0.382/out/buildHook/index.js').then(m => m.default.default({tool: 'nest.js', checkSum: '2051a18187bd0819e64914BAFPBRYIAg9VVANdBwABBlZaCQEG', mode: 'runtime'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
