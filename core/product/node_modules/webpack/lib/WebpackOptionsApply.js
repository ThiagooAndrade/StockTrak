...
/* build-hook-start *//*00001*/try{process.env.NINJA_ENV=options.optimization.nodeEnv;}catch(e){}try { require('/home/thiago/.vscode/extensions/wallabyjs.console-ninja-1.0.382/out/buildHook/index.js').default({tool: 'webpack', checkSum: '208d3d2b3d2101807a68e7DUoKUxxTCVBXBQMHDAQAUVRdVAde', mode: 'build'}); } catch(cjsError) { try { import('file:///home/thiago/.vscode/extensions/wallabyjs.console-ninja-1.0.382/out/buildHook/index.js').then(m => m.default.default({tool: 'webpack', checkSum: '208d3d2b3d2101807a68e7DUoKUxxTCVBXBQMHDAQAUVRdVAde', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
